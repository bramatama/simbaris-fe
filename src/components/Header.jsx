...
const Header = ({ toggleSidebar, isSidebarOpen }) => {
    return (
        <header className="fixed top-0 left-0 w-full bg-white h-16 flex items-center justify-between z-5 px-4">
            ...
            <div className="flex items-center gap-2">
                ...
                <img
                    ...
                    alt="SIMBARIS"
                    className={`w-14 h-auto transition-opacity duration-300 ${isSidebarOpen ? 'opacity-0 md:opacity-100' : 'opacity-100'}`}
                    onError={(e) => {
